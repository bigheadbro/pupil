...
public class GenerateMyBatisMapperUtil {
	...
	public static void main(String[] args) throws SQLException {
		...
		for(String table:args)
		{
			...
			// 模板文件所在的路径
			String path = "src/main/java/com/pupil/util";
			// 设置参数
			...
			try {
				...
				// 输出
			    //Writer sw = new PrintWriter(new FileOutputStream(new File("src/main/resources/mapper/pupil/entity/"+entity.getEntityName()+".java")));
